...
Invoke-Webrequest -uri https://raw.githubusercontent.com/MrMeeb/Intune-Choco-Universal-App-Installer/refs/heads/develop/Online/detect.ps1 -outfile "$TEMP\detect-$AppName.ps1"
