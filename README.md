# Chocolatey Universal App Installer

Enables the automatic installation of a Chocolatey package. Developed for use with Intune. Requires Chocolatey to be installed prior to app installation.
